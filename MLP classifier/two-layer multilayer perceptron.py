...
if __name__ == '__main__':
    ...
    while CounterT < 5:
        ...
        x1 = Dense(128, activation='relu', activity_regularizer=regularizers.l2(0.0001))(input1)
        ...
        x3 = Dense(256, activation='relu', activity_regularizer=regularizers.l2(0.0001))(input3)
